        ...
        try {
            switch ($action):
                ...
                case 'prepare_sagepay':
                    ...
                    /*  ADD RG/ie E TIPO   */                    
                    if (isset($billing_address_data['tipo'])) {
                        $this->getOnepage()->getQuote()->setCustomerTipo($billing_address_data['tipo']);
                        $billing_address_data['customer_tipo'] = $billing_address_data['tipo'];
                    }
                    if (isset($billing_address_data['rgie'])) {
                        $this->getOnepage()->getQuote()->setCustomerRgie($billing_address_data['rgie']);
                        $billing_address_data['customer_rgie'] = $billing_address_data['rgie'];
                    }                    
                    /*  ADD RG/ie E TIPO   */
                    ...
                    if ($this->getSession()->isLoggedIn() && $customer->getTaxvat() != $this->getOnepage()->getQuote()->getBillingAddress()->getTaxvat()) {
                        ...
                        $customer->setTipo($this->getOnepage()->getQuote()->getBillingAddress()->getTipo());
                        $customer->setRgie($this->getOnepage()->getQuote()->getBillingAddress()->getRgie());
                        $customer->save();
                    }
